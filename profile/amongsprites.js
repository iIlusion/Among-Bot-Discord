...
class AmongSprite {
    ...
    create = async (resolution=600, playerColor, bgName, hatName = undefined, outfitName = undefined, petName = undefined, ...overlays) => {
        ...
        return await canvas(resolution, playerColor, bgName, basePlayer, outfitName, hatName, petName, overlays)
    }
